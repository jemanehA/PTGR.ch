...
<style>
      ...
      <div className="container menudisplay breadcrumb">
        <Link to="/" ><span className="homemenu">Home</span></Link> <span className="separators">&nbsp;&nbsp;&gt;&nbsp;&nbsp;</span> <span className="current-page">Self-Study online Program</span>
      </div>
      ...
      <div className="ba-header">
        ...
        <h2>Self-Study Online Program</h2>
