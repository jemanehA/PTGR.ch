        ...
        <div className="row">
          ...
          <div className="col-md-4">
            <div className="course-card">
              ...
              />
              <h5 className="course-card-title">Digital Wealth Management</h5>
          ...
          <div className="col-md-4">
            <div className="course-card">
              <img
                ...
                className="course-card-img"
              />
              <h5 className="course-card-title">Blockchain Ecosystem </h5>
              <p className="course-card-description">
              Blockchain Ecosystem & Emergent Technologies
              </p>
              <button
                className="btn-get-started"
                onClick={handleGetStartedClick}
          ...
          <div className="col-md-4">
            <div className="course-card">
              <img
                ...
                className="course-card-img"
              />
              <h5 className="course-card-title">Passive Income Management</h5>
              <p className="course-card-description">
          ...
          <div className="col-md-4">
            <div className="course-card">
              <img
                ...
                className="course-card-img"
              />
              <h5 className="course-card-title">Crypto Trends & Market Cycles</h5>
              <p className="course-card-description">
              Crypto Trends & Market Cycles
              </p>
              <button
                className="btn-get-started"
                onClick={handleGetStartedClick}
          ...
          <div className="col-md-4">
            <div className="course-card">
              <img
                ...
                className="course-card-img"
              />
              <h5 className="course-card-title">DEFI</h5>
              <p className="course-card-description">
              DEFI
              </p>
              <button
          ...
          <div className="col-md-4">
            <div className="course-card">
              <img
                ...
                className="course-card-img"
              />
              <h5 className="course-card-title">Sustainable Investing</h5>
              <p className="course-card-description">
