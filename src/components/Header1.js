...
function Header() {
  ...
  const navItems = [
    ...
    },
    {
      ...
      path: '/homeWS',
      dropdown: [
        { label: 'Strategic ICO Execution', path: '/WS', state: { cardId: 'strategic-ico-execution' } },
        { label: 'ICO Set-Up and Fundraising', path: '/WS', state: { cardId: 'ico-setup-fundraising' } },
        { label: 'RWA Tokenization as a Service', path: '/WS', state: { cardId: 'rwa-tokenization' } },
        { label: 'Custody & Payment Solutions', path: '/WS', state: { cardId: 'custody-payments' } },
        { label: 'Metaverse Solutions', path: '/WS', state: { cardId: 'metaverse-solutions' } },
      ],
    },
    {
      id: 'ptgr',
